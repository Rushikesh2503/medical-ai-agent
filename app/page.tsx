  ...
  return (
    <div className="relative flex flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-teal-800 md:text-4xl lg:text-6xl dark:text-teal-200">
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-teal-700 dark:text-teal-300"
        >
